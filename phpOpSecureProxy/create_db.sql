...
(16, 0, 'SECURE_PROXY', 'securesecret', 0, '', '', '', '', 'SECURE_PROXY', '', '', 'http://secure_proxy/', '', 'client_secret_basic', '', '', 'http://localhost/projects/keystore.jwk', '', '', '', '', 'public', 'RS256', '', '', '', NULL, NULL, NULL, 0, 0, '', '', '', '', 'authorization_code|refresh_token', 'code|token|id_token|code token|code id_token|id_token token|code id_token token');
