...
(16, 0, 'TIM', 'timsecret', 0, '', '', '', '', 'TIM', '', '', 'http://tim/', '', 'client_secret_basic', '', '', 'http://localhost/projects/keystore.jwk', '', '', '', '', 'public', 'RS256', '', '', '', NULL, NULL, NULL, 0, 0, '', '', '', '', 'authorization_code|refresh_token', 'code|token|id_token|code token|code id_token|id_token token|code id_token token');
